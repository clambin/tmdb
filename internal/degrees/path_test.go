...
func TestPath_String(t *testing.T) {
	p := degrees.Path{
		...
		degrees.Link{Person: tmdb.Person{Id: 2, Name: "actor2"}, Entry: degrees.Entry{ID: 1, Name: "movie1"}},
		degrees.Link{Person: tmdb.Person{Id: 3, Name: "actor3"}, Entry: degrees.Entry{ID: 2, Name: "movie2"}},
	}
